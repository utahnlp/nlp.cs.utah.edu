...
<div class="container py-4">
    ...
    <div class="row people-split">
        ...
        <section class="col-12 col-lg-6 mb-5">
            <h2 class="border-bottom pb-2 mb-4">Postdoctoral Researchers</h2>
            {% make_people who:postdocs degree:Postdoctoral %}
        </section>
    </div>

    <section class="mb-5">
        <h2 class="border-bottom pb-2 mb-4">Doctoral Students</h2>
        {% make_people who:doctoral degree:PhD %}
    </section>

    <section class="mb-5">
        <h2 class="border-bottom pb-2 mb-4">Master's Students</h2>
        {% make_people who:masters degree:MS %}
    </section>
